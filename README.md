...
前往**中州·丹阁**，缴费灵石参加入门考核。缴费后材料存入背包，前往技艺→炼丹自行摸索。共三次机会，成功炼出考核丹药即获得一品炼丹师资质。三次用尽后可再缴费重考，失败面板根据寿元比例显示不同的搞笑台词。NPC 长老态度随境界和声望变化。
...
自由配药首次炼成某丹药后，丹方自动记录。之后可通过已知丹方路径使用，辅药选项和品质加成一目了然。自由配药路径始终不透露任何配方信息。
...
- ~~丹阁考核（中州·丹阁，缴费500灵石，获得材料自行摸索，三次机会，失败有搞笑三选一面板）~~
